...
public class VigenereCipher_TestCasesSubsetForStudents_1_ENVIRONMENT
{
	...
	public static final String LAST_NAME = "Dove";
	...
	public void correctClassNamePrefix()
	{
		...
		String actualClassName = getClassNameWithoutPackage(VigenereCipher_Dove.class);
	...
	public void correctPackageTest()
	{
		...
		String actualPackageName = VigenereCipher_Dove.class.getPackageName();
